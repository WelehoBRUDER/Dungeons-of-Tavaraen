...
function showInteractPrompt() {
  ...
  if (!foundPrompt) {
    (_a = maps[currentMap].entrances) === null || _a === void 0
      ? void 0
      : _a.some((entrance) => {
...
function hoverProjectile(projectile) {
  ...
  let mainStatText = "";
  mainStatText += `<f>19px<f>${(_b = lang["speed"]) !== null && _b !== void 0 ? _b : "speed"}: ${projectile.speed} ${
    (_c = lang["tiles_per_turn"]) !== null && _c !== void 0 ? _c : "tpt"
  }\n`;
  mainStatText += `<f>19px<f>${(_d = lang["origin"]) !== null && _d !== void 0 ? _d : "origin"}: ${
    lang[projectile.shooter.id + "_name"]
  }\n`;
  mainStatText += `<f>19px<f><i>${icons.damage}<i>${(_e = lang["predicted_damage"]) !== null && _e !== void 0 ? _e : "predicted_damage"}: ${
