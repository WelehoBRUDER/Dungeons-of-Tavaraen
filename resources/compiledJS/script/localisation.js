...
const finnish = {
    ...
    str_tt: `<i>${icons["str"]}<i>Voima parantaa <i>${icons["melee"]}<i>lähitaistelu aseiden vahinkoa 2%,\n ja parantaa maksimi taakkaa 0.5`,
    dex_tt: `<i>${icons["dex"]}<i>Taito parantaa <i>${icons["ranged"]}<i>kaukotaistelu aseiden vahinkoa 2%`,
...
const english = {
    ...
    stun_status: "Stun",
    bleed_status: "Bleed",
    str_tt: `<i>${icons["str"]}<i>Strength increases <i>${icons["melee"]}<i>melee damage by 2%,\n and encumbrance by 0.5`,
    dex_tt: `<i>${icons["dex"]}<i>Dexterity increases <i>${icons["ranged"]}<i>ranged damage by 2%`,
