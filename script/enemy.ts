...
class Enemy extends Character {
  ...
  constructor(base: enemy) {
    ...
    this.decideAction = async () => {
      ...
      if (chosenAbility && ((chosenAbility?.type == "charge" ? chosenAbility.use_range >= generatePath(this.cords, player.cords, this.canFly, true) : chosenAbility.use_range >= generateArrowPath(this.cords, player.cords, true)) || chosenAbility.self_target)) {
