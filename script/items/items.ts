const items = {
  ...
  dagger: {
    ...
    sprite: "resources/tiles/player/dagger_model.png",
    stats: {
      attackSpeedV: 25
    },
    price: 10,
  ...
  dualDaggers: {
    ...
    sprite: "resources/tiles/player/dual_daggers.png",
    stats: {
      attackSpeedV: 25
    },
    twoHanded: true,
  ...
  stick: {
    ...
    sprite: "resources/tiles/player/stick_model.png",
    price: 10,
    weight: 0.9,
    type: "weapon",
    statBonus: "str",
  ...
  trollClub: {
    ...
    sprite: "resources/tiles/player/troll_club.png",
    price: 75,
    weight: 5.4,
    type: "weapon",
    statBonus: "str",
  ...
  chippedBlade: {
    ...
    sprite: "resources/tiles/player/chipped_blade_model.png",
    price: 18,
    weight: 2.1,
    type: "weapon",
    statBonus: "str",
  ...
  longsword: {
    ...
    sprite: "resources/tiles/player/blade_model.png",
    price: 60,
    weight: 2.4,
    type: "weapon",
    statBonus: "str",
  ...
  silverSword: {
    ...
    sprite: "resources/tiles/player/silver_sword.png",
    price: 500,
    weight: 2.4,
    type: "weapon",
    statBonus: "str",
  ...
  stoneHalberd: {
    ...
    sprite: "resources/tiles/player/stone_halberd.png",
    price: 280,
    weight: 4.6,
    type: "weapon",
    statBonus: "str",
  ...
  galadorSpear: {
    ...
    sprite: "resources/tiles/player/spear_of_galador.png",
    price: 1500,
    weight: 1.9,
    type: "weapon",
    statBonus: "dex",
  ...
  pikeMore: {
    ...
    sprite: "resources/tiles/player/pikemore.png",
    price: 680,
    weight: 4.5,
    type: "weapon",
    statBonus: "str",
  ...
  chippedAxe: {
    ...
    sprite: "resources/tiles/player/chipped_axe_model.png",
    price: 35,
    weight: 2.9,
    type: "weapon",
    statBonus: "str",
  ...
  orcishAxe: {
    ...
    sprite: "resources/tiles/player/orcish_axe.png",
    price: 170,
    weight: 2.6,
    type: "weapon",
    statBonus: "str",
  ...
  huntingBow: {
    ...
    sprite: "resources/tiles/player/bow_model.png",
    price: 10,
    weight: 0.9,
    type: "weapon",
  ...
  hiisiBow: {
    ...
    sprite: "resources/tiles/player/hiisi_bow.png",
    price: 30,
    weight: 0.8,
    type: "weapon",
    firesProjectile: "arrowProjectile",
  ...
  longBow: {
    ...
    sprite: "resources/tiles/player/long_bow.png",
    price: 290,
    weight: 2,
    type: "weapon",
    firesProjectile: "arrowProjectile",
  ...
  goldBow: {
    ...
    sprite: "resources/tiles/player/gold_bow.png",
    price: 900,
    weight: 2,
    type: "weapon",
    firesProjectile: "arrowProjectile",
  ...
  apprenticeWand: {
    ...
    sprite: "resources/tiles/player/apprentice_wand.png",
    price: 25,
    weight: 1.2,
    type: "weapon",
  ...
  crimsonStaff: {
    ...
    sprite: "resources/tiles/player/crimson_staff.png",
    price: 280,
    weight: 1.7,
    type: "weapon",
  ...
  crystalWand: {
    ...
    sprite: "resources/tiles/player/crystal_wand.png",
    price: 800,
    weight: 1.7,
    type: "weapon",
  ...
  woodenShield: {
    ...
    sprite: "resources/tiles/player/wooden_shield.png",
    price: 13,
    weight: 1.2,
    type: "armor",
    grade: "common",
  ...
  ironShield: {
    ...
    sprite: "resources/tiles/player/iron_shield.png",
    price: 62,
    weight: 3.1,
    type: "armor",
    grade: "uncommon",
  ...
  silverShield: {
    ...
    sprite: "resources/tiles/player/silver_shield.png",
    price: 255,
    weight: 4.5,
    type: "armor",
    grade: "rare",
  ...
  parryingDagger: {
    ...
    sprite: "resources/tiles/player/parrying_dagger.png",
    stats: {
      damageP: 10,
      evasionV: 3
    },
  ...
  raggedShirt: {
    ...
    sprite: "resources/tiles/player/ragged_shirt.png",
    price: 6,
    weight: 0.8,
    type: "armor",
    grade: "common",
  ...
  raggedPants: {
    ...
    sprite: "resources/tiles/player/ragged_pants.png",
    price: 5,
    weight: 0.8,
    type: "armor",
    grade: "common",
  ...
  raggedBoots: {
    ...
    sprite: "resources/tiles/player/ragged_boots.png",
    price: 4,
    weight: 0.2,
    type: "armor",
    grade: "common",
  ...
  raggedGloves: {
    ...
    sprite: "resources/tiles/player/ragged_gloves.png",
    price: 3,
    weight: 0.15,
    type: "armor",
    grade: "common",
  ...
  enchantedCap: {
    ...
    sprite: "resources/tiles/player/enchanted_cap_of_skeletal_might.png",
    price: 25000,
    weight: 0.1,
    type: "armor",
    grade: "legendary",
  ...
  raggedHood: {
    ...
    sprite: "resources/tiles/player/ragged_hood.png",
    price: 5,
    weight: 0.2,
    type: "armor",
    grade: "common",
  ...
  woolHat: {
    ...
    sprite: "resources/tiles/player/wool_hat.png",
    price: 10,
    weight: 0.15,
    type: "armor",
    grade: "common",
  ...
  leatherChest: {
    ...
    sprite: "resources/tiles/player/leather_chest.png",
    price: 50,
    weight: 1.7,
    type: "armor",
    grade: "common",
  ...
  leatherLeggings: {
    ...
    sprite: "resources/tiles/player/leather_leg_bracers.png",
    price: 45,
    weight: 1.5,
    type: "armor",
    grade: "common",
  ...
  leatherBracers: {
    ...
    sprite: "resources/tiles/player/leather_bracers.png",
    price: 25,
    weight: 0.65,
    type: "armor",
    grade: "common",
  ...
  leatherHelmet: {
    ...
    sprite: "resources/tiles/player/leather_helmet.png",
    price: 30,
    weight: 0.5,
    type: "armor",
    grade: "common",
  ...
  leatherBoots: {
    ...
    sprite: "resources/tiles/player/leather_boots.png",
    price: 25,
    weight: 0.75,
    type: "armor",
    grade: "common",
  ...
  initiateRobe: {
    ...
    sprite: "resources/tiles/player/initiate_robe.png",
    price: 60,
    weight: 1,
    type: "armor",
    grade: "common",
  ...
  initiatePants: {
    ...
    sprite: "resources/tiles/player/initiate_pants.png",
    price: 45,
    weight: 0.7,
    type: "armor",
    grade: "common",
  ...
  initiateHood: {
    ...
    sprite: "resources/tiles/player/initiate_hood.png",
    price: 25,
    weight: 0.5,
    type: "armor",
    grade: "common",
  ...
  initiateGloves: {
    ...
    sprite: "resources/tiles/player/initiate_gloves.png",
    price: 20,
    weight: 0.6,
    type: "armor",
    grade: "common",
  ...
  initiateShoes: {
    ...
    sprite: "resources/tiles/player/initiate_shoes.png",
    price: 20,
    weight: 1.1,
    type: "armor",
    grade: "common",
  ...
  apprenticeRobe: {
    ...
    sprite: "resources/tiles/player/apprentice_robe.png",
    price: 500,
    weight: 2.1,
    type: "armor",
    grade: "uncommon",
  ...
  apprenticePants: {
    ...
    sprite: "resources/tiles/player/apprentice_pants.png",
    price: 400,
    weight: 1.5,
    type: "armor",
    grade: "uncommon",
  ...
  apprenticeBoots: {
    ...
    sprite: "resources/tiles/player/apprentice_boots.png",
    price: 250,
    weight: 0.2,
    type: "armor",
    grade: "uncommon",
  ...
  ironArmor: {
    ...
    sprite: "resources/tiles/player/iron_armor.png",
    price: 200,
    weight: 10.5,
    type: "armor",
    grade: "uncommon",
  ...
  ironLegplates: {
    ...
    sprite: "resources/tiles/player/iron_leg_plates.png",
    price: 150,
    weight: 5.25,
    type: "armor",
    grade: "uncommon",
  ...
  ironHelmet: {
    ...
    sprite: "resources/tiles/player/iron_helmet.png",
    price: 100,
    weight: 3,
    type: "armor",
    grade: "uncommon",
  ...
  ironGauntlets: {
    ...
    sprite: "resources/tiles/player/iron_gauntlets.png",
    price: 95,
    weight: 3.5,
    type: "armor",
    grade: "uncommon",
  ...
  ironBoots: {
    ...
    sprite: "resources/tiles/player/iron_boots.png",
    price: 95,
    weight: 4.5,
    type: "armor",
    grade: "uncommon",
  ...
  rangerArmor: {
    ...
    sprite: "resources/tiles/player/ranger_armor.png",
    price: 1200,
    weight: 6,
    type: "armor",
    grade: "uncommon",
  ...
  rangerPants: {
    ...
    sprite: "resources/tiles/player/ranger_pants.png",
    price: 800,
    weight: 3.5,
    type: "armor",
    grade: "uncommon",
  ...
  rangerHood: {
    ...
    sprite: "resources/tiles/player/ranger_hood.png",
    price: 600,
    weight: 1.25,
    type: "armor",
    grade: "uncommon",
  ...
  rangerGloves: {
    ...
    sprite: "resources/tiles/player/ranger_gloves.png",
    price: 500,
    weight: 1.5,
    type: "armor",
    grade: "uncommon",
  ...
  rangerBoots: {
    ...
    sprite: "resources/tiles/player/ranger_boots.png",
    price: 500,
    weight: 2.5,
    type: "armor",
    grade: "uncommon",
  ...
  crownOfWisdom: {
    ...
    sprite: "resources/tiles/player/crown_of_wisdom.png",
    price: 500,
    weight: 0.5,
    type: "armor",
    grade: "rare",
  ...
  lichRobes: {
    ...
    sprite: "resources/tiles/player/lich_robes.png",
    price: 305,
    weight: 4.5,
    type: "armor",
    grade: "uncommon",
  ...
  knightArmor: {
    ...
    sprite: "resources/tiles/player/knight_armor.png",
    price: 800,
    weight: 14.5,
    type: "armor",
    grade: "rare",
  ...
  knightGreaves: {
    ...
    sprite: "resources/tiles/player/knight_greaves.png",
    price: 525,
    weight: 7.5,
    type: "armor",
    grade: "rare",
  ...
  greathelm: {
    ...
    sprite: "resources/tiles/player/great_helm.png",
    price: 300,
    weight: 4.5,
    type: "armor",
    grade: "rare",
  ...
  knightGauntlets: {
    ...
    sprite: "resources/tiles/player/knight_gloves.png",
    price: 250,
    weight: 3.75,
    type: "armor",
    grade: "rare",
  ...
  knightSabatons: {
    ...
    sprite: "resources/tiles/player/knight_sabatons.png",
    price: 250,
    weight: 5,
    type: "armor",
    grade: "rare",
